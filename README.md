...
- Declares the `semantic-scholar` plugin slug (visible in `php bin/spora plugin:list`)
- Exposes an empty `tools()` hook (no tools contributed yet)
- Boots cleanly in a Spora install via `composer require spora-ai/spora-plugin-semantic-scholar:^0.1`
